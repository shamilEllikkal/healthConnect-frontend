                  ...
                  <div className="bg-white w-[500px] max-lg:w-full max-sm:w-full rounded-2xl shadow-xl ">
                    ...
                    <div className="p-6 max-sm:p-4 pt-0 text-center flex flex-col items-center justify-center gap-3  ">
                      <div className="relative">
                        <div className="relative">
                          {profileLoading && (
                            <div className="w-9 h-9 absolute top-[50%] left-[50%] z-6 -translate-1/2 border-4 border-gray-300 border-t-teal rounded-full animate-spin"></div>
                          )}
                    ...
                    {loading ? (
                      ...
                      <div>
                        ...
                        <div className="p-6 max-sm:p-4 pt-0">
                          <div className="grid grid-cols-2 justify-center items-center max-sm:grid-cols-1 gap-4">
                            <div>
                              <label
                                htmlFor="fullName"
                          ...
                          <div className="pt-6">
                            ...
                            <textarea
                              ...
                              id="address"
                              placeholder="Address"
                              className="flex min-h-[80px] w-full rounded-xl border  border-text-muted bg-white px-3 py-2 text-sm ring-offset-bg placeholder:text-text-muted focus-visible:outline-none focus-visible:ring-teal focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50 mt-2"
                            ></textarea>
                            <p className=" text-red-600 text-sm p-0.5 ">
