...
const schema = yup.object().shape({
  ...
  phone: yup.string()
    .min(10, "*Must be atleast 10 numbers").required("*Phone number is required"),
...
const UserProfile = () => {
  ...
  const handleFileUpload = async(event)=>{
    ...
    const res = await fetch("https://api.cloudinary.com/v1_1/druyim69w/image/upload",{
      method:"POST",
      body:profile,
 ...
 const profilePic = await axios.patch(`/user/update/${user.id}`,{profilePicture:URL} );
                ...
                <div className="bg-bg min-h-dvh space-y-6 max-sm:p-6 p-8 ">
                  ...
                  <div className="flex max-lg:flex-col gap-6">
                    <div className="bg-white w-[500px] max-lg:w-full max-sm:w-full rounded-2xl shadow-xl ">
                      ...
                      <div className="p-6 max-sm:p-4 pt-0 text-center flex flex-col items-center justify-center gap-3  ">
                        <div className="relative" >
                          <img loading="lazy" className="w-32 relative h-32 rounded-full object-cover border-4 border-gray-200" src={user.profile} alt="" />
                          <div>
                            <input type="file" onChange={handleFileUpload} className="w-8 h-8 flex items-center justify-center rounded-full text-md text-white/0 absolute bottom-0 right-0 bg-teal-500 "/>
                        
                        <div className="text-white absolute bottom-1 right-2">  <FontAwesomeIcon icon={faCamera} /></div>
                        </div>
                      </div>
                    ...
                    <div className="bg-white w-full rounded-2xl  shadow-xl ">
                      ...
                      <div className="p-6 max-sm:p-4 pt-0">
