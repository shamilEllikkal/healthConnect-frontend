      ...
      <div className="bg-white w-md h-full shadow-lg shadow-teal-500/10 rounded-lg flex flex-col items-center justify-between max-md:w-[448px] max-sm:w-full ">
        ...
        <div className="w-full pl-[24px] pr-[24px] ">
          <form onSubmit={handleSubmit(onSubmit)} noValidate action="">
            ...
            <div className="py-4">
              <button className=" text-[18px] h-[48px] w-full text-white bg-gradient-to-br from-teal-400 to-teal-700 font-medium text-lg  py-2 px-4 rounded-xl hover:shadow-lg transition justify-center items-center flex duration-300 ease-in-out ">
                {authLoading ? (
